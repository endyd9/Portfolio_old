const DB = () => {
  return (
    <div className="text-center">
      <h2 className="xl:mt-5 mt-32 xl:text-2xl text-5xl font-semibold">SQL</h2>
      <div className="xl:my-16 xl:mx-32 my-32 animate-up flex flex-row justify-center space-x-36">
        <figure className="xl:w-24 w-32 text-center">
          <img
            ...
            alt="mysql"
          />
          <figcaption className="xl:text-base text-3xl">MySql</figcaption>
        </figure>
      </div>
      ...
      <div className="my-16 mx-32 animate-up flex flex-row justify-center">
        <figure className="xl:w-24 w-32 text-center">
          <img
            ...
            alt="mongo"
          />
          <figcaption className="xl:text-base text-3xl">MongoDB</figcaption>
        </figure>
      </div>
    </div>
  );
